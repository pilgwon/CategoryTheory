...
<p align="center">
	...
	<p>Monoid hom-set seen as morphisms and as points in a set</p>
</p>
...
다음: A programming example of pure functions that do logging using [Kleisli 카테고리](https://bartoszmilewski.com/2014/12/23/kleisli-categories/)
